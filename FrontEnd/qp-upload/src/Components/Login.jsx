    ...
    <div>
         ...
         <form action="" onSubmit={handleSubmit}>
             <div className='flex flex-col h-96 justify-center items-center'>
                 ...
                 <input type="text" placeholder='Username ' id='username' className='outline-none w-96 m-3 border-black bg-transparent text-black text-center font-semibold border-b-2 h-14 placeholder:text-black' onChange={(e) => { setUsername(e.target.value) }} />
                 ...
                 <button type='submit' className='border-2 font-bold p-3 w-fit rounded-xl border-black m-5'>Login!</button>
